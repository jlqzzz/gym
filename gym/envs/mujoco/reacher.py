...
class ReacherEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    ...
    def step(self, a):
        ...
        return ob, reward, done, dict(reward_dist=reward_dist, reward_ctrl=reward_ctrl, show=reward)
...
class SparseReacherEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    ...
    def step(self, a):
        ...
        sparse_reward = 1 if np.abs(reward_dist) < 0.03 else 0
        return ob, sparse_reward, done, dict(reward_dist=reward_dist, reward_ctrl=reward_ctrl, show=reward)
...
class RobustReacherEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self):
        utils.EzPickle.__init__(self)
        mujoco_env.MujocoEnv.__init__(self, 'reacher.xml', 2)
